...
export const PATH_DASHBOARD = {
  ...
  default: path(ROOTS_DASHBOARD, '/category'),
  projects: path(ROOTS_DASHBOARD, '/main'),
  ecommerce: path(ROOTS_DASHBOARD, '/biling'),
  marketing: path(ROOTS_DASHBOARD, '/revues'),
  social: path(ROOTS_DASHBOARD, '/promo'),
  bidding: path(ROOTS_DASHBOARD, '/products'),
  learning: path(ROOTS_DASHBOARD, '/faq'),
  logistics: path(ROOTS_DASHBOARD, '/tables'),
  users: path(ROOTS_DASHBOARD, '/users'),
  telegramusers: path(ROOTS_DASHBOARD, '/telegramusers'),
  tusks: path(ROOTS_DASHBOARD, '/tusks'),
