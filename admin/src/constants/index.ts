...
const USER_PROFILE_ITEMS = [
  { title: 'Детали', path: PATH_USER_PROFILE.details },
  { title: 'Предпочтения', path: PATH_USER_PROFILE.preferences },
  { title: 'Информация', path: PATH_USER_PROFILE.personalInformation },
  { title: 'Безопасность', path: PATH_USER_PROFILE.security },
  { title: 'Активность', path: PATH_USER_PROFILE.activity },
  { title: 'Действия', path: PATH_USER_PROFILE.action },
  { title: 'Помощь', path: PATH_USER_PROFILE.help },
  { title: 'Обратная связь', path: PATH_USER_PROFILE.feedback },
];
