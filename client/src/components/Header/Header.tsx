...
<Button style={{height:'50px'}} type='primary' icon={<img height={30} src={'https://uxwing.com/wp-content/themes/uxwing/download/brands-and-social-media/whatsapp-white-icon.png'} />}>
Cвязаться с нами
</Button>
</a>
</div>
